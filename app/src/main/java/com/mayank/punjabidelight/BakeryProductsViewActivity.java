...
public class BakeryProductsViewActivity extends AppCompatActivity {
    ...
    ExtendedFloatingActionButton float_cakes,float_pastry,float_cakesonorder,float_menu,float_all;
    private boolean isOpen= false;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bakery_products_view);

        currentUser = FirebaseAuth.getInstance().getCurrentUser();

        float_cakes=(ExtendedFloatingActionButton)findViewById(R.id.floating_cakes);
        float_pastry=(ExtendedFloatingActionButton)findViewById(R.id.floating_pastry);
        float_cakesonorder=(ExtendedFloatingActionButton)findViewById(R.id.floating_cakesonorder);
        ...
        ProductsRef= FirebaseDatabase.getInstance().getReference().child("Products").child("bakery");
        ...
        float_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isOpen){
                    ...
                    float_cakes.setVisibility(View.INVISIBLE);
                    float_pastry.setVisibility(View.INVISIBLE);
                    float_cakesonorder.setVisibility(View.INVISIBLE);
                    ...
                    float_cakes.setVisibility(View.VISIBLE);
                    float_cakesonorder.setVisibility(View.VISIBLE);
                    float_pastry.setVisibility(View.VISIBLE);
        ...
        float_cakes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                filter_menu("cakes");
            }
        ...
        float_cakesonorder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                filter_menu("cakesonorder");
            }
        });

        float_pastry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                filter_menu("pastry");
            }
        ...
        Toolbar toolbar1= findViewById(R.id.toolbar_bakery);
        setSupportActionBar(toolbar1);
        TextView textView = toolbar1.findViewById(R.id.toolbar_title);
        textView.setText("BAKERY");

        ImageView imgs=toolbar1.findViewById(R.id.img_back);
        imgs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(BakeryProductsViewActivity.this,HomeActivity.class);
        ...
        imgss.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(BakeryProductsViewActivity.this,CartActivity.class);
                startActivity(intent);
            }
        });
