...
public class RiceProductsViewActivity extends AppCompatActivity {
    ...
    ExtendedFloatingActionButton float_rice,float_ricecombos,float_menu,float_all;
    private boolean isOpen= false;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rice_products_view);

        currentUser = FirebaseAuth.getInstance().getCurrentUser();

        float_rice=(ExtendedFloatingActionButton)findViewById(R.id.floating_rice);
        float_ricecombos=(ExtendedFloatingActionButton)findViewById(R.id.floating_ricecombos);
        ...
        ProductsRef= FirebaseDatabase.getInstance().getReference().child("Products").child("rice");
        ...
        float_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isOpen){
                    ...
                    float_ricecombos.setVisibility(View.INVISIBLE);
                    ...
                    float_ricecombos.setVisibility(View.VISIBLE);
        ...
        float_rice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                filter_menu("singlerice");
            }
        });

        float_ricecombos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                filter_menu("combos");
            }
        ...
        Toolbar toolbar1= findViewById(R.id.toolbar_rice);
        ...
        imgs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(RiceProductsViewActivity.this,HomeActivity.class);
        ...
        imgss.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(RiceProductsViewActivity.this,CartActivity.class);
                startActivity(intent);
            }
        });
