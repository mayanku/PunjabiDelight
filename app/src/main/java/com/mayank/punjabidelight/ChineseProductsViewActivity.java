...
public class ChineseProductsViewActivity extends AppCompatActivity {
    ...
    ExtendedFloatingActionButton float_chinatown,float_soups,float_menu,float_all;
    private boolean isOpen= false;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chinese_products_view);
        currentUser = FirebaseAuth.getInstance().getCurrentUser();

        float_chinatown=(ExtendedFloatingActionButton)findViewById(R.id.floating_chinatown);
        float_soups=(ExtendedFloatingActionButton)findViewById(R.id.floating_soups);
        ...
        ProductsRef= FirebaseDatabase.getInstance().getReference().child("Products").child("chinese");
        ...
        float_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isOpen){
                    ...
                    float_chinatown.setVisibility(View.INVISIBLE);
                    float_soups.setVisibility(View.INVISIBLE);
                    ...
                    float_chinatown.setVisibility(View.VISIBLE);
                    float_soups.setVisibility(View.VISIBLE);
        ...
        float_soups.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                filter_menu("soups");
            }
        ...
        float_chinatown.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                filter_menu("chinatown");
            }
        });
        ...
        Toolbar toolbar1= findViewById(R.id.toolbar_chinese);
        setSupportActionBar(toolbar1);
        TextView textView = toolbar1.findViewById(R.id.toolbar_title);
        textView.setText("CHINESE DISHES");

        ImageView imgs=toolbar1.findViewById(R.id.img_back);
        imgs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ChineseProductsViewActivity.this,HomeActivity.class);
        ...
        imgss.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ChineseProductsViewActivity.this,CartActivity.class);
                startActivity(intent);
            }
        });
