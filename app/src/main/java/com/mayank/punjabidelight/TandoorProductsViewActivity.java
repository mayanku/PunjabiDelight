...
public class TandoorProductsViewActivity extends AppCompatActivity {
    ...
    ExtendedFloatingActionButton float_parathas,float_thalis,float_tandoorstarters,float_menu,float_all;
    private boolean isOpen= false;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tandoor_products_view);

        currentUser = FirebaseAuth.getInstance().getCurrentUser();

        float_parathas=(ExtendedFloatingActionButton)findViewById(R.id.floating_parathas);
        float_thalis=(ExtendedFloatingActionButton)findViewById(R.id.floating_thalis);
        float_tandoorstarters=(ExtendedFloatingActionButton)findViewById(R.id.floating_tandoorStarters);
        ...
        ProductsRef= FirebaseDatabase.getInstance().getReference().child("Products").child("tandoor");
        float_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isOpen){

                    float_parathas.setVisibility(View.INVISIBLE);
                    float_thalis.setVisibility(View.INVISIBLE);
                    float_tandoorstarters.setVisibility(View.INVISIBLE);
                    ...
                    float_parathas.setVisibility(View.VISIBLE);
                    float_thalis.setVisibility(View.VISIBLE);
                    float_tandoorstarters.setVisibility(View.VISIBLE);
        ...
        float_parathas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                filter_menu("paratha");
            }
        ...
        float_thalis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                filter_menu("thali");
            }
        ...
        float_tandoorstarters.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                filter_menu("tandooristarters");
            }
        });
        ...
        Toolbar toolbar1= findViewById(R.id.toolbar_tandoor);
        setSupportActionBar(toolbar1);
        TextView textView = toolbar1.findViewById(R.id.toolbar_title);
        textView.setText("TANDOORI DISHES");

        ImageView imgs=toolbar1.findViewById(R.id.img_back);
        imgs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TandoorProductsViewActivity.this,HomeActivity.class);
        ...
        imgss.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(TandoorProductsViewActivity.this,CartActivity.class);
                startActivity(intent);
            }
        });
